...
# train_songs_list = r'C:\Users\priya\OneDrive\Desktop\songstrain1.txt'
test_songs_list = r'C:\Users\priya\OneDrive\Desktop\songstrain1.txt'
...
# Compute mel-spectogram for all the frames
    ...
    # X_train, y_train, num_frames_train = extract_melgrams(train_songs_list, MULTIFRAMES, process_all_song=False, num_songs_genre=)
    # print('X_train shape:', X_train.shape)
    X_test, y_test, num_frames_test = extract_melgrams(test_songs_list, MULTIFRAMES, process_all_song=False, num_songs_genre=1)
...
if LOAD_WEIGHTS:
    model.load_weights(weights_path+model_name+r'C:\Users\priya\Downloads\Music-Genre-Classification-with-Deep-Learning-master\Music-Genre-Classification-with-Deep-Learning-master\models_trained\example_model\weights\crnn_net_gru_adam_ours_epoch_40.h5')
